...
type DraftModalProps = {
  ...
  setIsShowingDraftModal: React.Dispatch<React.SetStateAction<boolean>>;
  notice: {
    id: string;
  };
};

const DraftNoticeModal: FC<DraftModalProps> = ({
  isShowing,
  hide,
  cancelButtonRef,
  setIsShowingDraftModal,
  notice,
}) => {
  ...
  const handleDraftChange = async () => {
    ...
    setIsShowingDraftModal(!isShowing);
  };
...
export default DraftNoticeModal;
